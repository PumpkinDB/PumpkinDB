 ...
 * Numbers
   ...
   * [UINT[size]/LT?](script/UINT_SIZED/LTQ.md)
   * [UINT[size]/GT?](script/UINT_SIZED/GTQ.md)
   * [UINT[size]/EQUAL?](script/UINT_SIZED/EQUALQ.md)
   ...
   * [INT[size]/LT?](script/INT_SIZED/LTQ.md)
   * [INT[size]/GT?](script/INT_SIZED/GTQ.md)
   * [INT[size]/EQUAL?](script/INT_SIZED/EQUALQ.md)
 * Data formats
